...
public class Settings extends BaseSettings {
    ...
    public static final StringSetting MISC_FEATURE_FLAGS = new StringSetting("misc_feature_flags", "bookmarks_in_timelines_enabled:false,view_counts_public_visibility_enabled:false,");
